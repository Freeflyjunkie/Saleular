...
namespace Saleular.Controllers
{
    ...
    public class PriceListRequestsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PriceListRequestId,BusinessName,Name,Email,Phone,Address,TaxId,BusinessAreaSelection,CreatedDate")] PriceListRequest priceListRequest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PriceListRequestId,BusinessName,Name,Email,Phone,Address,TaxId,BusinessAreaSelection,CreatedDate")] PriceListRequest priceListRequest)
        {
            if (ModelState.IsValid)
            {
